...
*/
			...
			featureDetector.detect(srcImage, pImageDescriptors->keyPoints);

            //【3】计算描述符（特征向量）
            OrbDescriptorExtractor featureExtractor;
			featureExtractor.compute(srcImage, pImageDescriptors->keyPoints, pImageDescriptors->descriptors);
...
int CPUImageIdentification::matchByDescriptors(Mat& captureDescriptionDes, ImageDescriptors* pImageDescriptors)
{
...
int CPUImageIdentification::match(Mat& image, ImageDescriptors* pImageDescriptors)
{
