...
#include "../../../../../eventPLclent/WebSocket/WebSocketServer.h"
...
QT_MOC_LITERAL(1, 16, 15), // "onClientConnect"
QT_MOC_LITERAL(2, 32, 0), // ""
QT_MOC_LITERAL(3, 33, 18) // "onClientDisconnect"

    },
    "WebSocketServer\0onClientConnect\0\0"
    "onClientDisconnect"
};
...
void WebSocketServer::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->onClientConnect(); break;
        case 1: _t->onClientDisconnect(); break;
        default: ;
        }
    }
    Q_UNUSED(_a);
...
const QMetaObject WebSocketServer::staticMetaObject = {
    { &QThread::staticMetaObject, qt_meta_stringdata_WebSocketServer.data,
...
void *WebSocketServer::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, "WSMsgHandler_back"))
        return static_cast< WSMsgHandler_back*>(const_cast< WebSocketServer*>(this));
