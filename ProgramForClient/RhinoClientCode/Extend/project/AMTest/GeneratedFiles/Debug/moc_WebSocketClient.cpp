...
#include "../../../../../eventPLclent/WebSocket/WebSocketClient.h"
...
QT_MOC_LITERAL(1, 16, 11), // "onConnected"
QT_MOC_LITERAL(2, 28, 0), // ""
QT_MOC_LITERAL(3, 29, 13), // "onCloseClient"
QT_MOC_LITERAL(4, 43, 7) // "isValid"

    },
    "WebSocketClient\0onConnected\0\0onCloseClient\0"
    "isValid"
};
...
void WebSocketClient::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        WebSocketClient *_t = static_cast<WebSocketClient *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->onConnected(); break;
        case 1: _t->onCloseClient(); break;
...
const QMetaObject WebSocketClient::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_WebSocketClient.data,
      qt_meta_data_WebSocketClient,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *WebSocketClient::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_WebSocketClient.stringdata0))
        return static_cast<void*>(const_cast< WebSocketClient*>(this));
